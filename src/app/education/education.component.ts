...
export class EducationComponent implements OnInit {
  cards: Array<any> = [
    {
      title: 'High School',
      subtitle: 'Science Park<br>May, 2011',
    ...
    {
      title: 'College',
      subtitle: 'Rutgers University<br>May, 2017',
    ...
    {
      title: 'Internship',
      subtitle: 'Wakefern Food Corp<br>May, 2016',
    ...
    },
    {
      ...
      subtitle: 'Wakefern Food Corp<br>September, 2017',
    ...
    },
    {
      ...
      subtitle: 'Wakefern Food Corp<br>May, 2017',
    ...
    {
      title: 'Programmer',
      subtitle: 'Wakefern Food Corp<br>September, 2018',
